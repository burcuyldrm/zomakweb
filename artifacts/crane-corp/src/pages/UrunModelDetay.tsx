        ...
        <div className="grid grid-cols-1 items-start gap-14 lg:grid-cols-2">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
            <div className="overflow-hidden rounded-[28px] bg-[#f3f3f3] p-8 shadow-sm">
              <div className="group relative flex min-h-[280px] items-center justify-center">
                {(activeImg || model.coverImage) ? (
                  <>
                    <img
                      src={activeImg || model.coverImage}
                      alt={model.name}
                      className="max-h-[480px] max-w-full rounded-2xl object-contain drop-shadow-[0_14px_18px_rgba(0,0,0,0.16)] cursor-zoom-in"
