                  ...
                  >
                    ...
                    <Link href={`/urunler/${category.slug}/${model.slug}`}>
                      <article className="group relative min-h-[250px] cursor-pointer overflow-hidden rounded-[26px] transition-all duration-300 hover:-translate-y-1.5">
                        ...
                        <div className="relative z-10 flex h-full flex-col px-6 py-6">
                          {model.coverImage && (
                            <div className="mb-4 flex h-[180px] items-center justify-center overflow-hidden rounded-xl">
                              <img
                                src={model.coverImage}
                                alt={model.name}
                                className="max-h-[170px] max-w-full object-contain transition-transform duration-500 group-hover:scale-105"
                              />
                            </div>
                          )}
